...
const TestimonialsSection: React.FC = () => {
  ...
  return <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-accent/30 rounded-lg">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
        {testimonials.map((testimonial, index) => <TestimonialCard key={index} name={testimonial.name} role={testimonial.role} content={testimonial.content} avatarText={testimonial.avatar} rating={testimonial.rating} />)}
      </div>
