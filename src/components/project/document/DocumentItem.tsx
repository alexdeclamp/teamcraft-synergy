...
const DocumentItem: React.FC<DocumentItemProps> = ({ 
  ...
  return (
    <>
      <div className="group">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between py-6 px-4 rounded-md hover:bg-slate-50/80 transition-colors cursor-pointer w-full gap-3">
          <DocumentItemHeader
            fileName={document.file_name}
